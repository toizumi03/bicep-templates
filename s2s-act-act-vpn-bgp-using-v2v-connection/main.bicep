...
module connectionCloudToOnp 'br/public:avm/res/network/connection:0.1.6' = {
  name: 'fromCloudtoOnp'
  params: {
    name: 'fromCloudtoOnp'
    location: locationSite1
    ...
    virtualNetworkGateway2ResourceId: onpreVpnGw.outputs.resourceId
...
module connectionOnpToCloud 'br/public:avm/res/network/connection:0.1.6' = {
  name: 'fromOnptoCloud'
  params: {
    name: 'fromOnptoCloud'
    location: locationSite2
    ...
    virtualNetworkGateway2ResourceId: cloudVpnGw.outputs.resourceId
    connectionType: 'Vnet2Vnet'
    vpnSharedKey: 'sharedpass'
    enableBgp: true
    routingWeight: 0
