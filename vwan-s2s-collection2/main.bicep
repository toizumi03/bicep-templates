...
module vpnsite1 '../modules/vhubvpnsite.bicep' = {
  ...
  params:{
    ...
    linkSpeedInMbps : 50
    vpnDeviceIpAddress : onprevpngateway1.outputs.publicIp01Address
...
module vpnsite2 '../modules/vhubvpnsite.bicep' = {
  ...
  params:{
    ...
    linkSpeedInMbps : 50
    vpnDeviceIpAddress : onprevpngateway1.outputs.publicIp02Address
    wanId : virtualwan.outputs.virtualwanId
  }
  dependsOn:[
    virtualwan
...
module vpnsite3 '../modules/vhubvpnsite.bicep' = {
  name: 'vpnsite3'
  params:{
    siteName: 'vpnsite3'
    location: locationSite1
    ...
    linkSpeedInMbps : 50
    vpnDeviceIpAddress : onprevpngateway2.outputs.publicIp01Address
    wanId : virtualwan.outputs.virtualwanId
  }
  dependsOn:[
    virtualwan
...
module vpnsite4 '../modules/vhubvpnsite.bicep' = {
  name: 'vpnsite4'
  params:{
    siteName: 'vpnsite4'
    location: locationSite1
    ...
    linkSpeedInMbps : 50
    vpnDeviceIpAddress : onprevpngateway2.outputs.publicIp02Address
    wanId : virtualwan.outputs.virtualwanId
  }
  dependsOn:[
    virtualwan
...
resource hubvpnsiteConnection3 'Microsoft.Network/vpnGateways/vpnConnections@2023-04-01' = {
  name: 'hubs2sgateway1/${vpnsite3.name}-connection'
  properties: {
    connectionBandwidth: 50
    enableBgp: true
    sharedKey: 'sharedpass'
    remoteVpnSite: {
      id: vpnsite3.outputs.vpnsiteid
    }
  }
  dependsOn:[
    hubs2sgateway1
...
resource hubvpnsiteConnection4 'Microsoft.Network/vpnGateways/vpnConnections@2023-04-01' = {
  name: 'hubs2sgateway1/${vpnsite4.name}-connection'
  properties: {
    connectionBandwidth: 50
    enableBgp: true
    sharedKey: 'sharedpass'
    remoteVpnSite: {
      id: vpnsite4.outputs.vpnsiteid
    }
  }
  dependsOn:[
    hubs2sgateway1
