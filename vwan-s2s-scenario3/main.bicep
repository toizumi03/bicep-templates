...
module hubs2sgateway2 '../modules/vhubs2sgateway.bicep' = {
  name: 'hubs2sgateway2'
  params:{
  hubgatewayName: 'hubs2sgateway2'
  location: locationSite2
...
resource hubvpnsite2Connection1 'Microsoft.Network/vpnGateways/vpnConnections@2023-11-01' = {
  name: 'hubs2sgateway2/${vpnsite2.name}-connection'
  properties:{
    remoteVpnSite: {
      id: vpnsite2.id
    }
    vpnLinkConnections: [
      {
        id: '${resourceId('Microsoft.Network/vpnGateways/vpnConnections',hubs2sgateway2.name,'vpnsite2-connection')}/vpnLinkConnections/link1'
        name: 'Link1'
        properties: {
          connectionBandwidth: 50
          dpdTimeoutSeconds: 0
      ...
      {
        id: '${resourceId('Microsoft.Network/vpnGateways/vpnConnections',hubs2sgateway2.name,'vpnsite2-connection')}/vpnLinkConnections/link2'
        name: 'Link2'
        properties: {
          connectionBandwidth: 50
          dpdTimeoutSeconds: 0
...
resource lng_cloud3 'Microsoft.Network/localNetworkGateways@2023-04-01' = {
  ...
  location: locationSite2
  properties: {
    gatewayIpAddress: hubs2sgateway2.outputs.gwpublicip1
    bgpSettings:{
      asn: 65515
      bgpPeeringAddress: hubs2sgateway2.outputs.gwdefaultbgpip1
    }
  }
}
...
resource lng_cloud4 'Microsoft.Network/localNetworkGateways@2023-04-01' = {
  ...
  location: locationSite2
  properties: {
    gatewayIpAddress:hubs2sgateway2.outputs.gwpublicip2
    bgpSettings:{
      asn: 65515
      bgpPeeringAddress: hubs2sgateway2.outputs.gwdefaultbgpip2
    }
  }
}
